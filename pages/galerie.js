...
export default function Galerie() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Navbar />
      <main className="flex-grow p-6 bg-gray-50 space-y-8">
        <h1 className="text-3xl font-bold text-green-700 mb-4">Galerie</h1>

        {/* 🎥 Carrousel vidéos */}
        {videos.length > 0 && (
          <div className="bg-white shadow p-4 rounded-lg">
            <h2 className="text-2xl font-semibold text-green-700 mb-3">Vidéos</h2>
            <Swiper
        ...
        {photos.length > 0 && (
          <div className="bg-white shadow p-4 rounded-lg">
            <h2 className="text-2xl font-semibold text-green-700 mb-3">Photos</h2>
            <Swiper
              modules={[Autoplay, Pagination]}
              spaceBetween={10}
              slidesPerView={3}
